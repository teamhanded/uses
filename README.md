...
¹ **Current**: Metakey [Tenet](https://clickclack.io/pages/metakey-tenet), Keychron [K6](https://www.keychron.com/products/keychron-k6-wireless-mechanical-keyboard). **Incoming**: Protozoa [Foundation](https://geekhack.org/index.php?topic=115707.0), Dygma [Defy](https://kickstarter.com/projects/deilor/defy-keyboard), Meletrix [Zoom65](https://zoom65.com/) v2.
...
* <details> 
	...
	* [nvim](https://github.com/neovim/neovim) / [helix](https://helix-editor.com/) + [hub](https://github.com/github/hub) + [git](https://git-scm.com/) + [task](https://taskfile.dev/) for terminal-based software development
