...
* <details> 
	...
	* [VSCodium](https://vscodium.com/) / [GoLand](https://jetbrains.com/go/) 
		+ [Terraform](https://marketplace.visualstudio.com/items?itemName=4ops.terraform), [OPA](https://marketplace.visualstudio.com/items?itemName=tsandall.opa) and [YAML](https://marketplace.visualstudio.com/items?itemName=redhat.vscode-yaml) plugins 
...
* <details> 
	...
	* [cilium](https://github.com/cilium/cilium) + [eBPF](https://ebpf.io) + [u-root](https://u-root.org/) + [gdb](http://gnu.org/software/gdb/) + [rizin](https://rizin.re/) + [valgrind](https://valgrind.org/) + [lldb](https://lldb.llvm.org/) + [honggfuzz](https://honggfuzz.dev/) + [afl++](https://aflplus.plus/) for vulnerability research, debugging and performance profiling 
