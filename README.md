...
* <details> 
	...
	* [cilium](https://github.com/cilium/cilium) + [eBPF](https://ebpf.io) + [u-root](https://u-root.org/) + [gdb](http://gnu.org/software/gdb/) + [radare2+rizin](https://rizin.re/) + [valgrind](https://valgrind.org/) + [lldb](https://lldb.llvm.org/) + [DynamoRIO](https://dynamorio.org/) + [honggfuzz](https://honggfuzz.dev/) + [afl++](https://aflplus.plus/) for vulnerability research, debugging and performance profiling 
